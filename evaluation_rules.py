...
E4_JUDGMENT_GUIDES: Dict[str, str] = {
    "学生对于学习的自信程度如何？（是否对于取得好的成绩有自信？）":
        ...
        "两者方向一致时一句话给结论；方向不一致（如效能感不低但学校表现自评偏低）时点明「对取得好成绩有信心，但对自己在校表现的评价偏低」这种落差并给方向。"
        "禁写：空泛鼓励、把自信写成性格。",
    "学校环境对学生是否产生了负面影响？":
