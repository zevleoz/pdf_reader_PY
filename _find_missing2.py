...
# B3 - 学习动机、学习方法与策略
print_page(b3_path, 5, "B3 工作记忆-1")
...
print_page(b3_path, 12, "B3 学习方法与策略-3")
print_page(b3_path, 13, "B3 学习方法与策略-4")

# B4 - 认知能力总得分、思维模式、自驱力
print_page(b4_path, 3, "B4 认知能力总览-1")
print_page(b4_path, 5, "B4 自我概念-2")
print_page(b4_path, 6, "B4 自我概念-3")
print_page(b4_path, 7, "B4 思维模式-1")
print_page(b4_path, 10, "B4 思维模式-2")
print_page(b4_path, 11, "B4 思维模式-3")
print_page(b4_path, 12, "B4 自驱力-1")
print_page(b4_path, 13, "B4 自驱力-2")
print_page(b4_path, 14, "B4 自驱力-3")
